...
$string['donebutton'] = 'Back to Homepage';
...
$string['setcoursevisibility'] = 'Save';
$string['showallcourses'] = 'Show All Courses';
$string['showhide'] = 'Show/Hide';
$string['searchfields'] = 'Enter username';
$string['shortname'] = 'Shortname';
$string['showbutton'] = 'Show Hidden Courses';
$string['showhidecourses'] = 'Show/Hide Settings';
$string['showhideinstructions'] = 'To hide courses, un-check the box next to the course name and click \'Save\'. <p/>To show hidden courses, check the box next to the course name and click \'Save\'.<p/>If a course is hidden, students will not be able to access it and it will not display on your homepage. <p/>';
